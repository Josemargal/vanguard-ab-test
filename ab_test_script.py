...
def save_dataframes(df_merged, data_summary, time_per_client_step, df_combined):
    df_merged.to_csv('processed_data/data_web_final.csv', index=False)
    data_summary.to_csv('processed_data/data_summary.csv', index=False)
    time_per_client_step.to_csv('processed_data/data_time_per_client_step.csv', index=False)
    df_combined.to_csv('processed_data/data_demo_final.csv', index=False)
