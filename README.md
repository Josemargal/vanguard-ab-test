...
- **Tableau File (vanguard-ab-test.twbx)**: Visualización interactiva del análisis en Tableau.
- **requirements.txt**: Contiene la lista de paquetes o bibliotecas necesarios para trabajar en el proyecto.
